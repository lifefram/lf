...
<div class="acadp acadp-listing">
	<div class="row">    	
        ...
        <div class="<?php echo $has_sidebar ? 'col-md-8' : 'col-md-12'; ?>">  
            ...
            <div class="pull-left acadp-post-title">        	
                ...
                if ( $can_show_category ) {
					...
					//Mel: 20/11/21
					$meta[] = sprintf( '<span class="glyphicon glyphicon-map-marker"></span>&nbsp;%s', implode( ', ', $category_links ) );
            ...
            <div class="pull-left">
				...
				//Count would be 1 if there's an IPFS CID for the bio.
                if ( count( $meta ) ) {
                    //Mel: 15/04/22.
					echo '<p><small class="text-muted mobile-description-bottom">' . implode( ' <br /> ', $meta ) . '</small></p>';
        ...
        <?php if ( $has_sidebar ) : ?>
			<!--Mel: 16/04/22 -->
			<div class="col-md-4 mobile-description-top">
            <!--<div class="col-md-4">-->
