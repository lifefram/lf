...
class ACADP_Public_Payments {
	...
	private function place_order() {
		...
		//Mel: 28/12/21. Grab the amount from checkout form. Amount can be more than 0 or 0.001
		...
		if ( $order_id ) {		
			...
			//Mel: 28/12/21. We don't use this cos we grab amount from the checkout form itself.
			// $amount = 0.00;
