		...
		<div class="social-block-wraper">
			<div class="global-section">
				...
				<div class="wslu-single-item">
					...
					<div class="wslu-right-content">
						<input class="social_switch_button" type="checkbox" id="email_new_registered_user" name="xs_global[email_new_registered_user][enable]" value="1" <?php echo (isset($return_data['email_new_registered_user']['enable']) && $return_data['email_new_registered_user']['enable'] == 1) ? 'checked' : ''; ?>>
