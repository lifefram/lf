...
<div class="wslu-social-login-main-wrapper">
    ...
    <form action="<?php echo esc_url(admin_url() . 'admin.php?page=wslu_settings'); ?>" method="POST">
        ...
        <div class="wslu-single-item">
            ...
            <div class="wslu-right-content">
                    <input 
                        ...
                        name="sync" 
                        value="yes" 
                        <?php echo \WP_Social\Helper\Helper::is_true($login_sync_saved_data, 'yes', 'checked') ?>
                    >
        ...
        <!-- 
         ...
         -->
         <div class="wslu-single-item initial-hidden <?php echo \WP_Social\Helper\Helper::is_true($login_sync_saved_data, 'yes', 'active_tr') ?>" id="xs_data_tr__1">
            <div class="wslu-left-label">
            ...
            <div class="wslu-right-content">
                    <input 
                        ...
                        name="sync_image" 
                        value="yes" 
                        <?php echo \WP_Social\Helper\Helper::is_true($login_sync_saved_data_image_too, 'yes', 'checked') ?>
                    >
