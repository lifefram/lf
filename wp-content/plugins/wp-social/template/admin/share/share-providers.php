                                ...
                                <div class="setting-section">
                                    <div class="wslu-popup-data">
                                        ...
                                        <div class="wslu-single-popup-item">
                                            <div class="setting-label-wraper">
                                                <label class="setting-label wslu-sec-title"
                                                       for="<?php echo $k; ?>_value">
													<?php echo __('Default ' . $label . ' Share Count', 'wp-social'); ?>
                                                </label>
                                            </div>

                                            <input name="xs_share[social][<?php echo $k; ?>][data][value]" type="text"
                                                   id="xs_<?php echo $k; ?>_value"
                                        ...
                                        <div class="wslu-single-popup-item">
                                            <div class="setting-label-wraper">
                                                <label class="setting-label wslu-sec-title"
                                                       for="<?php echo $k; ?>_text"><?php echo __('Text Below The Number', 'wp-social'); ?> </label>
                                            </div>

                                            <input name="xs_share[social][<?php echo $k; ?>][data][text]" type="text"
                                        ...
                                        <div class="wslu-single-popup-item">
                                            <div class="setting-label-wraper">
                                                <label class="setting-label wslu-sec-title"
                                                       for="<?php echo $k; ?>_label"><?php echo __('Label Name', 'wp-social'); ?> </label>
                                            </div>

                                            <input name="xs_share[social][<?php echo $k; ?>][data][label]" type="text"
