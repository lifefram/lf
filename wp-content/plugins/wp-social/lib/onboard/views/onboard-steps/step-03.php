    ...
    <div class="attr-row">
        ...
        <div class="attr-col-lg-4">
            <div class="wslu-onboard-single-plugin">
                <label>
                    <img class="wslu-onboard-single-plugin--logo" src="<?php echo self::get_url(); ?>assets/images/onboard/shopengine-logo.png" alt="ShopEngine">
        ...
        <div class="attr-col-lg-4">
            <div class="wslu-onboard-single-plugin">
                <label>
                    <img class="wslu-onboard-single-plugin--logo" src="<?php echo self::get_url(); ?>assets/images/onboard/metform-logo.png" alt="Metform">
        ...
        <div class="attr-col-lg-4">
            <div class="wslu-onboard-single-plugin">
                <label>
                    <img class="wslu-onboard-single-plugin--logo" src="<?php echo self::get_url(); ?>assets/images/onboard/elementskit-logo.svg" alt="WpSocial">
        ...
        <div class="attr-col-lg-4">
            <div class="wslu-onboard-single-plugin">
                <label>
                    <img class="wslu-onboard-single-plugin--logo" src="<?php echo self::get_url(); ?>assets/images/onboard/ultimate-review-logo.png" alt="UltimateReview">
        ...
        <div class="attr-col-lg-4">
            <div class="wslu-onboard-single-plugin">
                <label>
                    <img class="wslu-onboard-single-plugin--logo" src="<?php echo self::get_url(); ?>assets/images/onboard/fundraising-logo.png" alt="Fundraising">
                    <p class="wslu-onboard-single-plugin--description"><?php echo esc_html__('Integrate various styled review system in your website', 'wp-social'); ?></p>
...
<div class="wslu-onboard-pagination">
    <a class="wslu-onboard-btn wslu-onboard-pagi-btn prev" data-plugin_status="<?php echo $plugin['status']; ?>" data-activation_url="<?php echo $plugin['activation_url'] ?>" href="#"><i class="icon xs-onboard-arrow-left"></i><?php echo esc_html__('Back', 'wp-social'); ?></a>
    <a class="wslu-onboard-btn wslu-onboard-pagi-btn next" data-plugin_status="<?php echo $plugin['status']; ?>" data-activation_url="<?php echo $plugin['activation_url'] ?>" href="#"><?php echo esc_html__('Next Step', 'wp-social'); ?></a>
</div>
