...
<div class="wslu-admin-fields-container <?php echo isset($_GET['wp-social-met-onboard-steps']) && $_GET['wp-social-met-onboard-steps'] == 'loaded' ? 'wslu-admin-widgets-container' : 'wslu-admin-widget-list'; ?>">
    ...
    <div class="wslu-admin-fields-container-fieldset">
        <?php foreach (\WP_Social\Lib\Onboard\Onboard::settings() as $page_key => $pages): ?>
            <h2 class="wslu-widget-group-title"><?php echo ucwords(str_replace('_', ' ', $page_key)); ?></h2>
            <div class="attr-row">
