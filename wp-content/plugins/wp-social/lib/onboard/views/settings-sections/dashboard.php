<div class="wslu-admin-card wslu-admin-card-shadow">
    <img src="<?php echo self::get_url() . 'assets/images/banner_dashboard.png'; ?>" class="wslu-admin-dashboard-banner" />
</div>

<!-- Documentation -->
<div class="wslu-admin-section wslu-admin-dual-layout wslu-admin-documentation-section">
    <div class="wslu-admin-left-thumb">
        <img src="<?php echo self::get_url() . 'assets/images/documentation-thumb.png'; ?>" alt="<?php esc_attr_e('Documentation Thumb', 'wp-social'); ?>">
    </div>
    ...
    <div class="wslu-admin-video-tutorial-list">
        <div class="wslu-admin-video-tutorial-item">
            <a target="_blank" href="https://wpmet.com/plugin/elementskit/parallax-landing/">
                <div class="tutorial-thumb">
                    <img src="<?php echo self::get_url() . 'assets/images/suport-thumb.png'; ?>" alt="<?php esc_attr_e('Totorial Thumb', 'wp-social'); ?>">
                </div>
        ...
        <div class="wslu-admin-video-tutorial-item">
            <a href="#" data-video_id="oV-7-NNiGZo">
                <div class="tutorial-thumb">
                    <img src="<?php echo self::get_url() . 'assets/images/subscribed-thumb.png'; ?>" alt="<?php esc_attr_e('Totorial Thumb', 'wp-social'); ?>">
                </div>
        ...
        <div class="wslu-admin-video-tutorial-item">
            <a href="#" data-video_id="LfFN08Y9VQE">
                <div class="tutorial-thumb">
                    <img src="<?php echo self::get_url() . 'assets/images/featured-request-thumb.png'; ?>" alt="<?php esc_attr_e('Totorial Thumb', 'wp-social'); ?>">
                </div>
...
<div class="wslu-admin-right-content">
    ...
    <div class="wslu-admin-left-thumb">
        <img src="<?php echo self::get_url() . 'assets/images/suport-thumb.png'; ?>" alt="<?php esc_attr_e('Documentation Thumb', 'wp-social'); ?>">
    </div>
...
<div class="wslu-admin-section wslu-admin-dual-layout wslu-admin-feature-request-section wslu-admin-except-title">
    <div class="wslu-admin-left-thumb">
        <img src="<?php echo self::get_url() . 'assets/images/featured-request-thumb.png'; ?>" alt="<?php esc_attr_e('Feature a Request Thumb', 'wp-social'); ?>">
    </div>
    <div class="wslu-admin-right-content">
...
<div class="wslu-admin-section wslu-admin-dual-layout wslu-admin-rate-now-section wslu-admin-except-title">
    ...
    <div class="wslu-admin-left-thumb">
        <img src="<?php echo self::get_url() . 'assets/images/rate-now-thumb.png'; ?>" alt="<?php esc_attr_e('Rate Now Thumb', 'wp-social'); ?>">
    </div>
</div>