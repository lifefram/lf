...
class KnowledgeCenter_Comments extends Walker_Comment {
        ...
        <div class="content is-size-7-mobile">
            ...
            <div class="level is-mobile">
                <div class="level-left">
					<?php if ( function_exists( 'knowledgecenter_get_helpful' ) ) : ?>
                        <div class="level-item">
							<?php knowledgecenter_get_comment_voted( $comment_id ); ?>
                        </div>
					<?php endif; ?>
                    <div class="level-item">
						<?php
