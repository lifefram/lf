...
<footer role="contentinfo" id="footer">  
  <div id="inner-footer" class="clearfix container padding-top-bottom">
	...
	<div id="widget-footer" class="clearfix row">
        ...
        <nav class="footer-menu-nav">
     	<ul class="footer-nav nav navbar-nav">
			...
			//Mel: 11/04/22. To fix the error "Trying to access array offset on value of type bool in.."
			$footer_social_icon_default = array(
                  array('url'=>$mywiki_options['fburl'] ?? false,'icon'=>'fa-facebook'),
				  //array('url'=>$mywiki_options['fburl'],'icon'=>'fa-facebook'),
                  array('url'=>$mywiki_options['twitter'] ?? false,'icon'=>'fa-twitter'),
				  //array('url'=>$mywiki_options['twitter'],'icon'=>'fa-twitter'),
                  array('url'=>$mywiki_options['googleplus'] ?? false,'icon'=>'fa-google-plus'),
				  //array('url'=>$mywiki_options['googleplus'],'icon'=>'fa-google-plus'),
                  array('url'=>$mywiki_options['linkedin'] ?? false,'icon'=>'fa-linkedin'),
    ...
    <p class="attribution">
	   <?php
		//Mel: 11/04/22. To fix the error "Trying to access array offset on value of type bool in.."
		$footertext = get_theme_mod('footertext',$mywiki_options['footertext'] ?? false);
		//$footertext = get_theme_mod('footertext',$mywiki_options['footertext']);
		if(!empty($footertext)):
			echo esc_attr(get_theme_mod('footertext',$mywiki_options['footertext'] ?? false)); 
